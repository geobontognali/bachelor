...
Die Aussensprechstelle wird durch 3 Anti Vandalismus Schalter bedient. Die Aufgabe des Keymapper ist sicherzustellen das bei einem Tastendruck eine Aktion auf der Aussensprechselle ausgeführt wird. Die drei Schalter wurden an GPIO Pins des Raspberry PI angeschlossen. Wie im Kapitel (\seeref{fig:Java})
