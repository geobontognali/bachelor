...
class Config
{
    ...
    public $speakerControllerServer = "127.0.0.1"; // IP Address of the Relay Controller (Should always be localhost for best security)
    public $speakerControllerServerPort = 7000; // Port of the Relay Controller (Default 7000)
